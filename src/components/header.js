                          ...
                          <div className="container">
                              <div className="row">
                                  ...
                                  <div className="col-lg-2 col-md-2 font-14 d-flex justify-content-end">
                                      <span className="mr-2"> <a href="https://www.facebook.com/ivision.webstudio.9" target="_blank" className="socialIcon"><i className="fab fa-facebook-f black font-14"></i></a></span>
                                      <span className="mr-2"> <a href="https://www.instagram.com/ivisionwebstudio/" className="socialIcon" target="_blank"><i className="fab fa-instagram black font-14"></i></a></span>
                                      <span className="mr-2"> <a href="https://in.linkedin.com/company/ivision-studio" className="socialIcon" target="_blank"><i className="fab fa-linkedin-in black font-14"></i></a></span>
                                  </div>
                              </div>
                          </div>
                      </div>
